  ...
  return function (e) {
    ...
    (e.da = function () {
      ...
      (e.da.stopWordFilter = e.generateStopWordFilter(
        "ad af alle alt anden at blev blive bliver da de dem den denne der deres det dette dig din disse dog du efter eller en end er et for fra ham han hans har havde have hende hendes her hos hun hvad hvis hvor i ikke ind jeg jer jo kunne man manage med meget men mig min mine mit mod ned noget nogle nu når og også om op os over på self sig sin sine sit skal skulle some sådan thi til ud under var vi vil ville for være været".split(
          " ",
        ),
      )),
