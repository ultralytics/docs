...
- **Edge Deployment:** The removal of DFL and optimization for CPU inference make it ideal for [mobile apps](https://docs.ultralytics.com/hub/app/) and IoT devices.
