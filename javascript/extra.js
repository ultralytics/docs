...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const config = {
    baseSettings: {
      ...
      colorMode: { enableSystem: true },
      theme: {
        styles: [
          { key: "main", type: "link", value: "/stylesheets/style.css" },
          {
            key: "chat-button",
            type: "style",
            value: ` .ikp-chat-button__button{background-color: #E1FF25;color: #111F68;}[data-theme="dark"] .ikp-chat-button__button{background-color: #40434f;color: #ffffff;}.ikp-chat-button__container{position: fixed;right: 1rem;bottom: 3rem;}`,
          },
        ],
      },
    },
